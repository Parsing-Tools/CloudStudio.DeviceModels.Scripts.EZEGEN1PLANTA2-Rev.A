...
function getEndpoints(deviceAddress, endpoints)
{
 ...
 endpoints.addEndpoint("1", "Camara de Frio B", endpointType.temperatureSensor);
 endpoints.addEndpoint("2", "Sala de Envasado", endpointType.temperatureSensor);
 endpoints.addEndpoint("3", "Puerta cámara de frio C", endpointType.iasSensor, iasEndpointSubType.doorSensor);
 endpoints.addEndpoint("4", "Productos Terminados", endpointType.temperatureSensor);
 endpoints.addEndpoint("5", "Puerta cámara de frio B", endpointType.iasSensor, iasEndpointSubType.doorSensor);
 endpoints.addEndpoint("6", "Puerta cámara de frío C exterior", endpointType.iasSensor, iasEndpointSubType.doorSensor);
 endpoints.addEndpoint("12", "Camara de Frio C", endpointType.temperatureSensor);
 endpoints.addEndpoint("7", "Sensor de produccion", endpointType.genericSensor).variableTypeId = 1015;
 endpoints.addEndpoint("8", "Produccion acumulada diaria", endpointType.genericSensor).variableTypeId = 1014;
