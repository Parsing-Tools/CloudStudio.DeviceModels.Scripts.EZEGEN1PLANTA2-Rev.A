...
# Parsing + Configuration Script – EZEGEN1_PLANTA2 - Rev. A

This **Parsing + Configuration** script is designed for the **EZEGEN1_PLANTA2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EZEGEN1_PLANTA2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **EZEGEN1_PLANTA2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
